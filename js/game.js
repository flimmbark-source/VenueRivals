...
const GUESTS = {
  ...
  groupChatHost: {
    ...
    venue: "Neutral", tags: ["Broker", "VIP"], tier: "uncommon",
    ability: { package: "curate" },
    desc: "CURATE — Reveal the next 2 guests and choose their order.",
  },
  plusOnePrince: {
    name: "Plus-One Prince", emoji: "👑",
    heat: 2, money: 1, points: 2, cost: 4,
  ...
  nameDropper: {
    ...
    heat: 1, money: 2, points: 0, cost: 7,
  ...
  porchBuddy: {
    ...
    heat: 0, money: 0, points: 1, cost: 3,
  ...
  fedUpRoommate: {
    ...
    heat: 2, money: 1, points: 1, cost: 5,
  ...
  resetHost: {
    ...
    heat: 0, money: 1, points: 2, cost: 6,
    ...
    dealer: {
    name: "Dealer", emoji: "🤛",
    heat: 2, money: 2, points: 0, cost: 7,
    venue: "Neutral", tags: ["Outlaw", "Broker"], tier: "Rare",
    ability: { package: "nudge" },
    desc: "NUDGE — Nudge a guest.",
  },
  ...
  mainCharacter: {
    ...
    heat: 2, money: 2, points: 3, cost: 8,
  ...
  afterpartyHost: {
    ...
    heat: 0, money: 0, points: 3, cost: 9,
    venue: "Velvet Room", tags: ["Performer"], tier: "uncommon",
    ability: { package: "bounce" },
    desc: "BOUNCE — Return a guest in your house to the top of your queue.",
  },
  wallflower: {
    ...
    heat: 1, money: 2, points: 1, cost: 8,
    venue: "Velvet Room", tags: ["VIP", "Broker"], tier: "common",
  ...
  headliner: {
    ...
    heat: 2, money: 2, points: 2, cost: 8,
  ...
  windowWatcher: {
    ...
    heat: 1, money: 1, points: 1, cost: 4,
  ...
  magnetGuest: {
    ...
    heat: 1, money: 1, points: 3, cost: 8,
  ...
  dramaStarter: {
    ...
    heat: 2, money: 0, points: 2, cost: 4,
    venue: "Back Alley", tags: ["Outlaw"], tier: "common",
  ...
  chaosChaser: {
    ...
    heat: 3, money: 1, points: 1, cost: 7,
  ...
  rumorQueen: {
    ...
    heat: 2, money: 1, points: 2, cost: 7,
  ...
  counselor: {
    ...
    heat: 0, money: 0, points: 3, cost: 7,
    venue: "Back Alley", tags: ["Scout", "VIP"], tier: "rare",
    ability: { package: "cool1" },
    desc: "COOL 1 — On arrival, Cool 1.",
  },
  cupid: {
    ...
    venue: "Back Alley", tags: ["Performer", "VIP"], tier: "rare",
    ability: { package: "boot" },
    desc: "BOOT — Remove a guest from your house.",
  },
      ...
      case "refreshAction": {
        ...
        if (targetIdx < 0) {
          const refreshable = player.house.filter((e, i) => {
            ...
            return !!getGuestAbility(g)?.isActive;
          });
