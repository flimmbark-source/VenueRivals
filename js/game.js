...
const Game = (() => {
    ...
    const GUESTS = {
        ...
        usher: { name: 'Usher', emoji: '🧤', heat: 1, money: 1, points: 2, cost: 3, venue: 'Neutral', tags: ['VIP'], desc: 'Enter: Pull another guest. Guest List: Lock that guest.', tier: 'common', enter: { type: 'pullAnotherGuest' }, ability: { name: 'Guest List', icon: '🔒', desc: 'Admit then lock the pulled guest', trigger: 'flash', type: 'pullThenLock' } },
        ...
        floorRunner: { name: 'Floor Runner', emoji: '🏃', heat: 2, money: 1, points: 1, cost: 3, venue: 'Neutral', tags: ['Scout'], desc: 'Crowd Surf: Push the Leftmost. Exit: +1 Point.', tier: 'common', ability: { name: 'Crowd Surf', icon: '↩️', desc: 'Admit then push leftmost', trigger: 'flash', type: 'pushLeftmost' }, exit: { points: 1 } },
        ...
        velvetBouncer: { name: 'Velvet Bouncer', emoji: '🛡️', heat: 1, money: 1, points: 1, cost: 4, venue: 'Velvet Room', tags: ['VIP'], desc: 'VIP Rope: Lock another guest. Exit: +2 Money.', tier: 'uncommon', ability: { name: 'VIP Rope', icon: '⛓️', desc: 'Admit then lock another guest', trigger: 'flash', type: 'lockAnother' }, exit: { money: 2 } },
        ...
        galleryScout: { name: 'Gallery Scout', emoji: '🔭', heat: 1, money: 2, points: 1, cost: 4, venue: 'Night Market', tags: ['Scout'], desc: 'Neon Peek: Reveal 2. Queue 1, Stash 1.', tier: 'common', ability: { name: 'Neon Peek', icon: '🧭', desc: 'Look at 2: keep 1, stash 1', trigger: 'flash', type: 'scoutQueue' } },
        ...
        wheelman: { name: 'Wheelman', emoji: '🚗', heat: 1, money: 3, points: 1, cost: 4, venue: 'Back Alley', tags: ['Outlaw'], desc: 'Last Call: Push another guest. Exit: +2 Money.', tier: 'common', ability: { name: 'Last Call', icon: '↪️', desc: 'Admit then push another guest', trigger: 'flash', type: 'pushAnother' }, exit: { money: 2 } },
