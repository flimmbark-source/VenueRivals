...
const Game = (() => {
    ...
    const GUESTS = {
        ...
        floorRunner: { name: 'Floor Runner', emoji: '🏃', heat: 2, money: 1, points: 1, cost: 3, venue: 'Neutral', tags: ['Scout'], desc: 'Flash: Push the Leftmost. Exit: +1 Point.', tier: 'common', ability: { name: 'Flash', icon: '↩️', desc: 'Admit then push leftmost', trigger: 'flash', type: 'pushLeftmost' }, exit: { points: 1 } },
        ...
        velvetBouncer: { name: 'Velvet Bouncer', emoji: '🛡️', heat: 1, money: 1, points: 1, cost: 4, venue: 'Velvet Room', tags: ['VIP'], desc: 'Flash: Lock another guest. Exit: +2 Money.', tier: 'uncommon', ability: { name: 'Flash', icon: '⛓️', desc: 'Admit then lock another guest', trigger: 'flash', type: 'lockAnother' }, exit: { money: 2 } },
        ...
        wheelman: { name: 'Wheelman', emoji: '🚗', heat: 1, money: 3, points: 1, cost: 4, venue: 'Back Alley', tags: ['Outlaw'], desc: 'Flash: Push another guest. Exit: +2 Money.', tier: 'common', ability: { name: 'Flash', icon: '↪️', desc: 'Admit then push another guest', trigger: 'flash', type: 'pushAnother' }, exit: { money: 2 } },
